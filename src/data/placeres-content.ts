...
export const placeresContent: Record<string, PlacerContent> = {
  ...
  astronomia: {
    ...
    subtitle: "Del cosmos a las constelaciones: ciencia estelar, observación del cielo y el mapa del zodiaco",
    heroImage: "https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=1200&q=80",
    intro: "Desde la observación de planetas con un telescopio casero hasta las historias milenarias detrás de cada constelación del zodiaco, este Placer une la ciencia astronómica con la tradición astrológica. Aprenderás a identificar constelaciones, entender el cosmos, y explorar el mapa interactivo del cielo nocturno con sus mitos y significados.",
    curiosity: "Las constelaciones del zodiaco llevan más de 3,000 años con los mismos nombres. Los babilonios las definieron siguiendo el camino del Sol. La luz de Próxima Centauri tarda 4.24 años en llegar: cuando miras el cielo, ves el pasado.",
    articles: [
      { id: "astro-1", title: "Guía para principiantes: tu primera noche de observación", excerpt: "Todo lo que necesitas saber para empezar a observar el cielo nocturno.", content: "La observación astronómica comienza a simple vista. Primero, busca un lugar con poca contaminación lumínica. Las aplicaciones como Stellarium o Sky Map te ayudan a identificar lo que ves. Empieza reconociendo las constelaciones más fáciles: Orión en invierno con sus tres estrellas del cinturón, la Osa Mayor que apunta a la estrella Polar, y Escorpio en verano con su corazón rojo Antares. Con unos binoculares 10x50 puedes ver los cráteres de la Luna, las lunas de Júpiter y cúmulos estelares como las Pléyades. El siguiente paso es un telescopio: para principiantes se recomienda un reflector Dobsoniano de 150mm que ofrece una excelente relación calidad-precio.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=600&q=80", readTime: "6 min", category: "Guía" },
      { id: "astro-2", title: "Los planetas del sistema solar: qué puedes ver con tu telescopio", excerpt: "Júpiter y sus lunas, los anillos de Saturno, las fases de Venus desde tu patio.", content: "Con un telescopio modesto puedes ver detalles sorprendentes de nuestros vecinos planetarios. Júpiter revela sus bandas de nubes y hasta cuatro lunas galileanas como puntos brillantes que cambian de posición cada noche. Saturno muestra sus anillos incluso con un telescopio de 60mm, una vista que literalmente quita el aliento la primera vez. Venus exhibe fases como la Luna y Marte muestra su casquete polar cuando está en oposición. El truco está en la paciencia y conocer los mejores momentos: cuando un planeta está en oposición está más cerca y brillante.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1614732414444-096e5f1122d5?w=600&q=80", readTime: "7 min", category: "Observación" },
      { id: "astro-3", title: "Astrofotografía: captura el universo con tu cámara", excerpt: "Desde fotos de la Vía Láctea con smartphone hasta nebulosas con equipo especializado.", content: "La astrofotografía ha vivido una revolución gracias a las cámaras digitales. Con un smartphone moderno y una exposición larga puedes capturar la Vía Láctea desde un cielo oscuro. La regla del 500 ayuda a evitar trazos estelares: divide 500 entre la distancia focal de tu lente para obtener el tiempo máximo de exposición. Para ir más allá necesitas una montura ecuatorial motorizada que compense la rotación terrestre. Software como DeepSkyStacker combina docenas de fotos para reducir el ruido y revelar detalles invisibles al ojo humano.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?w=600&q=80", readTime: "8 min", category: "Astrofotografía" },
      { id: "astro-4", title: "El Big Bang y el origen del universo", excerpt: "La historia de los primeros minutos del cosmos que crearon todo lo que existe.", content: "Hace aproximadamente 13,800 millones de años, todo el universo observable estaba comprimido en un punto de densidad y temperatura infinitas. En las primeras fracciones de segundo tras el Big Bang, el universo se expandió exponencialmente en un proceso llamado inflación cósmica. A los 3 minutos se formaron los primeros núcleos atómicos de hidrógeno y helio. Pasaron 380,000 años hasta que el universo se enfrió lo suficiente para que los electrones se unieran a los núcleos, liberando la luz que hoy detectamos como la radiación cósmica de fondo.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=600&q=80", readTime: "6 min", category: "Cosmología" },
      { id: "astrol-1", title: "Los 12 signos del zodiaco: origen y significado astronómico", excerpt: "Las constelaciones zodiacales marcan el camino del Sol. Su historia va mucho más allá de los horóscopos.", content: "El zodiaco es una franja del cielo de unos 18 grados de ancho centrada en la eclíptica, el camino aparente que recorre el Sol a lo largo del año. Las 12 constelaciones que cruza fueron identificadas por los babilonios hace más de 3,000 años. Cada mes, el Sol parece estar frente a una constelación diferente. Aries marca el equinoccio de primavera, Cáncer el solsticio de verano, Libra el equinoccio de otoño y Capricornio el solsticio de invierno. Debido a la precesión del eje terrestre, las fechas astrológicas ya no coinciden con las astronómicas.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1532968961962-8a0cb3a2d4f5?w=600&q=80", readTime: "6 min", category: "Zodiaco" },
      { id: "astrol-2", title: "Cómo encontrar las constelaciones: guía práctica", excerpt: "Trucos para orientarte en el cielo: desde la Osa Mayor hasta la Cruz del Sur.", content: "Orientarse en el cielo nocturno es más fácil de lo que parece si conoces algunos trucos. En el hemisferio norte, la Osa Mayor es tu punto de partida: sus dos estrellas delanteras apuntan directamente a la Estrella Polar (Polaris). Orión es el gran referente invernal: su cinturón de tres estrellas es inconfundible. Siguiendo el cinturón hacia abajo encuentras Sirio (la estrella más brillante), y hacia arriba llegas a Aldebarán en Tauro. En el hemisferio sur, la Cruz del Sur apunta al polo sur celeste. Aprende 5 constelaciones y podrás encontrar las demás.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=600&q=80", readTime: "7 min", category: "Guía práctica" },
      { id: "astrol-3", title: "Mitología griega en las estrellas", excerpt: "Cada constelación esconde una historia épica de dioses, héroes y monstruos.", content: "El cielo nocturno es un teatro mitológico. Orión, el cazador gigante, persigue eternamente a las Pléyades mientras Escorpio lo acecha desde el lado opuesto del cielo. Perseo sostiene la cabeza de Medusa mientras vuela sobre Pegaso. Andrómeda, encadenada como sacrificio al monstruo Cetus, es rescatada por Perseo. Casiopea fue condenada a girar eternamente por su vanidad. Los gemelos Cástor y Pólux comparten la inmortalidad en Géminis. Cada cultura tiene sus propias historias: los aborígenes australianos ven un emú en los espacios oscuros de la Vía Láctea.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=600&q=80", readTime: "8 min", category: "Mitología" },
      { id: "astrol-4", title: "Los 4 elementos: Fuego, Tierra, Aire y Agua", excerpt: "Cada signo zodiacal pertenece a un elemento que define su energía.", content: "La astrología clasifica los 12 signos en 4 elementos. Los signos de Fuego (Aries, Leo, Sagitario) representan la energía y la pasión. Los de Tierra (Tauro, Virgo, Capricornio) representan la estabilidad y lo práctico. Los de Aire (Géminis, Libra, Acuario) representan el intelecto y la comunicación. Los de Agua (Cáncer, Escorpio, Piscis) representan las emociones y la intuición. Esta clasificación tiene raíces en la filosofía griega de los cuatro elementos de Empédocles.", country: "Internacional", countryFlag: "🌍", image: "https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?w=600&q=80", readTime: "5 min", category: "Elementos" },
    ],
    debates: [
      { id: "d-astro-1", type: "VS", title: "Telescopio reflector vs refractor: ¿cuál para empezar?", description: "El eterno debate entre los dos tipos principales de telescopios.", optionA: "Reflector (Newton)", optionB: "Refractor", votesA: 58, votesB: 42, responses: 31, author: "AstroMDCO", date: "2026-03-16" },
      { id: "d-astro-2", type: "Opinion", title: "¿Cuál fue el objeto celeste que más te impresionó ver?", description: "Todos tenemos esa primera vez con el telescopio que nos dejó sin palabras.", responses: 27, author: "StarGazer", date: "2026-03-10" },
      { id: "d-astrol-1", type: "VS", title: "¿Te identificas más con tu signo solar o tu ascendente?", description: "Muchas personas sienten que su ascendente los describe mejor.", optionA: "Signo solar", optionB: "Ascendente", votesA: 67, votesB: 89, responses: 45, author: "MapaCeleste", date: "2026-03-22" },
      { id: "d-astrol-2", type: "Opinion", title: "¿Cuál es tu constelación favorita y por qué?", description: "Comparte cuál constelación te fascina más.", responses: 38, author: "StarLover", date: "2026-03-18" },
      { id: "d-astrol-3", type: "Mitos", title: "¿La luna llena realmente afecta el comportamiento humano?", description: "Un mito popular que se mantiene. ¿Tú qué opinas?", responses: 52, author: "LunarMDCO", date: "2026-03-12" },
    ],
    encuestas: [
      ...
      { id: "e-astrol-2", question: "¿Crees que los signos influyen en la personalidad?", options: [{ text: "Sí, totalmente", votes: 78 }, { text: "Algo de verdad hay", votes: 134 }, { text: "Es solo entretenimiento", votes: 56 }, { text: "No creo en eso", votes: 42 }], totalVotes: 310, author: "MDCO", date: "2026-03-15" },
    ],
    gallery: [
  ...
  destilados: {
    ...
    subtitle: "Whisky, ron, gin, vodka, tequila y el arte de la mixología: de la destilación al cóctel perfecto",
    heroImage: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=1200&q=80",
    intro: "Los destilados son el resultado de siglos de alquimia líquida. Desde los monasterios medievales que destilaban 'agua de vida' hasta los maestros mezcladores modernos que crean cócteles de autor, este mundo combina química, tradición, creatividad y placer sensorial. En este Placer explorarás los grandes espíritus del mundo y aprenderás el arte de la coctelería.",
    curiosity: "La palabra 'whisky' viene del gaélico 'uisce beatha' que significa 'agua de vida'. Los monjes irlandeses fueron de los primeros en destilar, y la técnica se extendió a Escocia donde nació el Scotch.",
    articles: [
      {
        id: "dest-1",
        title: "Guía completa de tipos de whisky: de Escocia a Japón",
        excerpt: "Single Malt, Bourbon, Rye, Japonés: cada tipo tiene personalidad propia. Aprende a distinguirlos como un experto.",
        content: "El whisky es un universo de sabores que varía enormemente según su origen y método de producción.\n\nEl Single Malt Scotch se elabora exclusivamente con cebada malteada en una única destilería escocesa. Se destila generalmente dos veces en alambiques de cobre y envejece mínimo 3 años en barricas de roble (frecuentemente ex-bourbon). Las regiones escocesas tienen personalidades distintas: Islay produce whiskies ahumados y marinos, Speyside ofrece perfiles florales y afrutados, y las Highlands van desde lo suave hasta lo robusto.\n\nEl whiskey irlandés se distingue por su triple destilación, que le otorga una suavidad y redondez excepcionales. Se envejece un mínimo de 7 años, muchas veces en barricas de Jerez que aportan notas de frutos secos y especias. Irlanda fue históricamente el mayor productor mundial antes de que Escocia la superara.\n\nEl Bourbon americano debe contener al menos 51% de maíz en su receta de granos. Se destila principalmente en Kentucky y envejece en barricas nuevas de roble americano carbonizado, lo que le da sus características notas de vainilla, caramelo y miel. El Tennessee Whiskey, como Jack Daniel's, se filtra adicionalmente por carbón de arce.\n\nEl Rye Whiskey usa alto contenido de centeno, produciendo un perfil más especiado y picante. El whisky japonés sigue métodos escoceses pero con una precisión y sutileza que le ha ganado premios internacionales. Destilerías como Yamazaki y Nikka han redefinido el estándar mundial.\n\nEl whisky canadiense combina centeno malteado y maíz con un mínimo de 3 años de maduración, produciendo perfiles suaves y versátiles ideales para coctelería.",
        country: "Internacional",
        countryFlag: "🌍",
      ...
      {
        id: "dest-2",
        title: "Ron: la historia del espíritu del Caribe",
        excerpt: "De la caña de azúcar al ron añejo: un viaje por las islas que crearon la bebida más versátil del trópico.",
        content: "El ron nació en el Caribe en el siglo XVII, cuando los esclavos de las plantaciones de caña descubrieron que la melaza podía fermentarse y destilarse. Desde entonces, cada isla caribeña ha desarrollado su propio estilo.\n\nEl ron cubano (Havana Club) es ligero y seco, perfecto para el Mojito y el Daiquirí. El ron jamaicano (Appleton) es intenso y funky, con aromas de plátano y ésteres que lo hacen inconfundible. El ron de Barbados (Mount Gay, la destilería más antigua del mundo desde 1703) equilibra dulzura y complejidad. El ron guatemalteco (Zacapa) y el venezolano (Diplomático) se añejan en sistemas de solera y alcanzan suavidades comparables a un coñac.\n\nExisten tres categorías principales: el ron blanco (sin añejamiento o filtrado), ideal para cócteles frescos; el ron dorado (1-3 años en barrica), con notas de vainilla y caramelo; y el ron añejo (5+ años), que se disfruta solo como un whisky fino. Los rones agrícolas de Martinica y Guadalupe se destilan directamente del jugo de caña fresca, no de melaza, produciendo un perfil herbáceo y floral completamente diferente.",
        country: "Caribe",
        countryFlag: "🏝️",
      ...
      {
        id: "dest-3",
        title: "Coctelería clásica: los 10 cócteles que todo amante de los destilados debe conocer",
        excerpt: "Old Fashioned, Negroni, Martini, Mojito... la historia y receta de los cócteles que definieron la mixología.",
        content: "La coctelería clásica se construye sobre un puñado de recetas que han resistido más de un siglo.\n\nEl Old Fashioned (1880) es el abuelo de todos: bourbon, azúcar, amargo de Angostura y un twist de naranja. Simple y perfecto. El Negroni (1919, Florencia) mezcla partes iguales de gin, Campari y vermut rojo, creando un equilibrio amargo-dulce adictivo. El Martini (1910s) es gin y vermut seco, agitado o revuelto, con aceituna o twist de limón: el cóctel más elegante jamás creado.\n\nEl Mojito cubano combina ron blanco, lima, menta, azúcar y soda en la frescura tropical perfecta. El Daiquirí, también cubano, es la destilación de la simplicidad: ron, lima y azúcar batidos con hielo. La Margarita mexicana une tequila, triple sec y lima con borde de sal.\n\nEl Whisky Sour equilibra la potencia del bourbon con la acidez del limón y la dulzura del jarabe. El Manhattan (1870s, Nueva York) mezcla rye whiskey con vermut dulce y amargo. El Gin & Tonic, nacido en la India colonial británica como medicina contra la malaria, se ha reinventado con botánicos artesanales. El Espresso Martini (1983, Londres) unió el mundo del café con la coctelería y sigue siendo el cóctel más pedido del mundo.",
        country: "Internacional",
        countryFlag: "🌍",
      ...
      {
        id: "dest-4",
        title: "Tequila y Mezcal: los espíritus sagrados de México",
        excerpt: "Del agave azul al mezcal artesanal: la historia de las bebidas que México le regaló al mundo.",
        content: "El tequila y el mezcal son destilados de agave con siglos de historia. El tequila solo puede producirse con agave azul (Agave tequilana) en cinco estados de México, principalmente Jalisco. El mezcal puede usar más de 30 variedades de agave y se produce principalmente en Oaxaca.\n\nEl tequila se clasifica en: Blanco (sin envejecimiento, sabor puro de agave), Reposado (2-12 meses en barrica, notas de vainilla), Añejo (1-3 años, complejidad similar al whisky) y Extra Añejo (3+ años, el más suave y premium). La diferencia entre un tequila de $15 y uno de $150 está en si es 100% agave o mixto, y en el tiempo de envejecimiento.\n\nEl mezcal artesanal se produce de forma ancestral: las piñas de agave se cuecen en hornos de tierra bajo piedras calientes (lo que da su característico sabor ahumado), se muelen con tahona de piedra y fermentan en tinas de madera con levaduras silvestres. Cada maestro mezcalero, cada parcela y cada variedad de agave producen un destilado único e irrepetible. El mezcal está viviendo un renacimiento mundial similar al que vivió el whisky single malt hace 30 años.",
        country: "México",
        countryFlag: "🇲🇽",
    ...
    debates: [
      ...
      { id: "d-dest-2", type: "Ranking", title: "Top 5 cócteles clásicos de todos los tiempos", description: "La comunidad vota: ¿cuáles son los cócteles que todo amante de la mixología debe dominar?", responses: 56, author: "MixologistMDCO", date: "2026-03-15" },
      { id: "d-dest-3", type: "Recomendacion", title: "Mejor whisky para regalar por menos de $50", description: "Busco un whisky que impresione pero sin romper el banco. ¿Qué recomiendan?", responses: 38, author: "GiftHunter", date: "2026-03-10" },
      { id: "d-dest-4", type: "Mitos", title: "¿El tequila bueno no da resaca?", description: "Dicen que el tequila 100% agave no produce resaca. ¿Mito o realidad?", responses: 45, author: "AgaveLover", date: "2026-03-05" },
    ],
    encuestas: [
      { id: "e-dest-1", question: "¿Cuál es tu destilado favorito?", options: [{ text: "Whisky", votes: 112 }, { text: "Ron", votes: 78 }, { text: "Tequila/Mezcal", votes: 65 }, { text: "Gin", votes: 54 }], totalVotes: 309, author: "MDCO", date: "2026-03-18" },
      { id: "e-dest-2", question: "¿Cómo prefieres tomar tu whisky?", options: [{ text: "Solo, sin hielo (neat)", votes: 89 }, { text: "Con hielo (on the rocks)", votes: 67 }, { text: "Con un poco de agua", votes: 34 }, { text: "En cóctel", votes: 56 }], totalVotes: 246, author: "MDCO", date: "2026-03-12" },
    ],
    gallery: [
      { src: "https://images.unsplash.com/photo-1527281400683-1aae777175f8?w=400&q=80", caption: "Whisky single malt", author: "Comunidad MDCO" },
      { src: "https://images.unsplash.com/photo-1536935338788-846bb9981813?w=400&q=80", caption: "Cócteles clásicos", author: "Comunidad MDCO" },
      { src: "https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=400&q=80", caption: "Ron añejo", author: "Comunidad MDCO" },
      { src: "https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=400&q=80", caption: "Tequila artesanal", author: "Comunidad MDCO" },
    ],
  },
};
